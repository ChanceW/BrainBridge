...
export default function WorksheetAnalytics({ questions, score, completedAt, timeSpent }: WorksheetAnalytics) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold mb-6">Worksheet Analytics</h2>
      
      {/* Score Overview */}
      <div className="grid grid-cols-3 gap-4 mb-8">
        <div className="bg-bg-blue bg-opacity-10 p-4 rounded-lg text-center">
          <div className="text-3xl font-bold text-bg-blue-dark mb-1">{score}%</div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {timeSpent && (
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="font-medium">{Math.round(timeSpent / 60)} minutes</div>
            </div>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        {questionsByCorrectness.incorrect.length > 0 && (
          <div className="mb-6">
            <h4 className="text-md font-medium text-red-600 mb-2">Areas for Improvement</h4>
        ...
        {questionsByCorrectness.correct.length > 0 && (
          <div>
            <h4 className="text-md font-medium text-green-600 mb-2">Strong Areas</h4>
            <ul className="space-y-2">
